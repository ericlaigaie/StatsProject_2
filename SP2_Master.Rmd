...
#set.seed(1234)
#mtry <- sqrt(ncol(x))
#rf_random <- train(pay_response~., data=df_trainclean, method="rf", metric="Accuracy", tuneLength=15, trControl=control)
#print(rf_random)
#plot(rf_random)

#Train Model with RF
train.rf<-randomForest(pay_response~.,data=df_trainclean,mtry=4,ntree=50,importance=T)
