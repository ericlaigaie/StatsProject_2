...
full.roc.step = performance(results.step, measure = "tpr", x.measure = "fpr")
...
fit.int <- glm(pay_response ~ age + hours_per_week + capital_net + sex + sex:age + workclass:sex + occupation:marital_status + capital_net:age + capital_net:workclass + native_country:sex + education + education:age + hours_per_week:capital_net, family='binomial', data=df_trainclean)
