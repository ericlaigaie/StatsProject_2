...
train.rf<-randomForest(pay_response~.,data=df_trainclean,mtry=2,ntree=50000,importance=T)
fit.pred.rf<-predict(train.rf,newdata=df_trainclean,type="prob")
...
auc.train.rf <- performance(pred.table.rf, measure = "auc")
auc.train.rf <- auc.train.rf@y.values
plot(roc.perf.rf)
abline(a=0, b= 1)
