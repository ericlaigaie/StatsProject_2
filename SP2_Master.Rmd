...
###check correlation of continous values
```{r}
...
ggplot(df_train2, aes(y=education, x=education_num)) + geom_boxplot(fill='indianred2') + labs(title='Education_num distribution by Education - Train') + scale_y_discrete("education", limits = c("Preschool" , "Grade School", "HS Grads", "Assocs", "Bachelors" , "Masters" , "Docs/Profs"))

ggplot(df_test2, aes(y=education, x=education_num)) + geom_boxplot(fill='indianred2') + labs(title='Education_num distribution by Education - Test') + scale_y_discrete("education", limits = c("Preschool" , "Grade School", "HS Grads", "Assocs", "Bachelors" , "Masters" , "Docs/Profs"))
