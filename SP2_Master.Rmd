...
###Will look for multicollinearity, ways to reduce levels in our categorialc responses and removing columns in our clean output.
...
plot(df_trainclean$workclass~df_trainclean$education,col=c("orange","blue"))
```
