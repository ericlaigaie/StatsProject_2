...
df_train2 <- select (df_train2,-c(capital_gain, capital_loss))
df_test2 <- select (df_test2,-c(capital_gain, capital_loss))
```
...
df_train2 <- select (df_train2,-c(education_num))
df_test2 <- select (df_test2,-c(education_num))
```
